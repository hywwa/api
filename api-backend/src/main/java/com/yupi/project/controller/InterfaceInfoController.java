...
public class InterfaceInfoController {
    ...
    public BaseResponse<Object> invokeInterfaceInfo(@RequestBody InterfaceInfoInvokeRequest interfaceInfoInvokeRequest,
        ...
        YuApiClient tempClient = new YuApiClient(accessKey, secretKey);//使用ak，sk创造实例
        Gson gson = new Gson();//userRequestParams反序列化为com.yupi.yuapiclientsdk.model.User
        com.yupi.yuapiclientsdk.model.User user = gson.fromJson(userRequestParams, com.yupi.yuapiclientsdk.model.User.class);
        String usernameByPost = tempClient.getUsernameByPost(user);//调用
        return ResultUtils.success(usernameByPost);//返回成功
    }
